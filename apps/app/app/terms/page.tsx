            ...
            <PageBody className="flex max-w-3xl flex-col gap-8">
                ...
                <Section icon={AlertTriangle} tint="text-caution" title="Important Disclaimers">
                    ...
                    <Subsection
                        ...
                        body="AI features are available only to adults 18 or older and require separate permission to share data with Google. FinnaBot and Budget Analysis responses are generated by an AI model. They can be incomplete or wrong, and are not financial, tax, or legal advice. Verify anything important with a qualified professional."
                    />
                    <Subsection
