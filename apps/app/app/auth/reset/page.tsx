        ...
        <AuthSplit>
            ...
            <form onSubmit={onSubmit} className="flex flex-col gap-3">
                <input
                    ...
                    className="h-11 w-full rounded-md border border-input bg-background px-3.5 text-base text-foreground  transition placeholder:text-muted-foreground focus:border-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background"
                />
